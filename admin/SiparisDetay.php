...
<table width="750" align="right" valign="top" border="0" cellpadding="0" cellspacing="0" style="margin-left: 360px;">
  <tr height="130">
	...
	<tr height="70">
		<td width="560" bgcolor="#ff9999" style="color: #262626;" align="left"><h3>&nbsp;Sipariş Detay</h3></td>
	...
	<tr>
		<td colspan="2"><form action="index.php?skd=0&ski=99&SiparisNo=<?php echo geriDondur($GelenSiparisNo); ?>" method="post">
			<table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
				<tr height="40">
					<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="120"><b>Gönderi Kodu</b></td>
							<td width="50"><b>:</b></td>
							<td width="480"><input type="text" name="GonderiKodu" class="inputs" style="text-align:center;"></td>
						</tr>
					</table></td>
				</tr>
				<tr height="40">
					<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100">&nbsp;</td>
							<td width="10">&nbsp;</td>
							<td align="right" width="540"><input type="submit" value="Gönderi Kodunu İşle ve Siparişi Tamamla" class="buttons"></td>
						</tr>
					</table></td>
				</tr>
			</table>
