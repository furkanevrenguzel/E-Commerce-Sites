...
<table width="1065" align="left" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="1065" align="left" valign="top"><table width="550" align="left" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
						...
						<tr height="30">
						<td><a href="index.php?sk=114" style="text-decoration: none; <?php if($GelenMenuId==''){ ?>color: #cc0099;<?php }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler [<?php echo $AnaMenununTumUrunSayiSorgusu["MenununToplamUrunu"]; ?>]</a></td>
	          </tr>
					<?php
					...
					?>
						<tr height="30">
							<td><a href="index.php?sk=114&MenuID=<?php echo $Menu["id"]; ?>" style="text-decoration: none;<?php if($GelenMenuId==$Menu['id']){ ?> color: #cc0099;
		...
		<td width="1000" align="left" valign="top"><table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><div class="Arama"><form action="index.php?sk=114" method="post">
					<?php
					if($GelenMenuId!=""){
					?>
          ...
          <a href="index.php?sk=83" style="text-decoration: none; color: #ff00aa;">Normal</a></td>
			...
			<tr>
				<td><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr><?php
						$UrunlerSorgusu		=	$db_baglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Yüzük' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY UrunAdi DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
			...
			<tr height="50">
				<td align="center"><div class="Sayfalama">
					...
					<div class="SayfalamaNumara">
						<?php
						if($Sayfalama>1){
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=114" . $SayfalamaKosulu . "&page=1'><<</a></span>";
							$SayfalamaIcinSayfaDegeriniBirGeriAl	=	$Sayfalama-1;
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=114" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
						}
						...
						for($SayfalamaIcinSayfaIndexDegeri=$Sayfalama-$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri<=$Sayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++){
							if(($SayfalamaIcinSayfaIndexDegeri>0) and ($SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi)){
								if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
									...
									echo "<span class='SayfalamaPasif'><a href='index.php?sk=114" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
								}
							}
						}
						if($Sayfalama!=$BulunanSayfaSayisi){
							$SayfalamaIcinSayfaDegeriniBirIleriAl	=	$Sayfalama+1;
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=114" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=114" . $SayfalamaKosulu . "&page=" . $BulunanSayfaSayisi . "'>>></a></span>";
						}
						?>
					</div>
				</div></td>
