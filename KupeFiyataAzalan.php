...
$ToplamKayitSayisiSorgusu				=	$db_baglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Küpe' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
$ToplamKayitSayisiSorgusu->execute();
$ToplamKayitSayisiSorgusu				=	$ToplamKayitSayisiSorgusu->rowCount();
$SayfalamayaBaslanacakKayitSayisi		=	($Sayfalama*$SayfaBasinaGosterilecekKayitSayisi)-$SayfaBasinaGosterilecekKayitSayisi;
$BulunanSayfaSayisi						=	ceil($ToplamKayitSayisiSorgusu/$SayfaBasinaGosterilecekKayitSayisi);

$AnaMenununTumUrunSayiSorgusu		=	$db_baglantisi->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru = 'Küpe'");
...
<table width="1065" align="left" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="1065" align="left" valign="top"><table width="550" align="left" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><table width="250" align="center" border="0" cellpadding="0" cellspacing="0">
						...
						<tr height="30">
						<td><a href="index.php?sk=116" style="text-decoration: none; <?php if($GelenMenuId==''){ ?>color: #cc0099;<?php }else{ ?>color: #646464;<?php } ?> font-weight: bold;">&nbsp;Tüm Ürünler [<?php echo $AnaMenununTumUrunSayiSorgusu["MenununToplamUrunu"]; ?>]</a></td>
	          </tr>
					<?php
					$MenulerSorgusu		=	$db_baglantisi->prepare("SELECT * FROM menuler WHERE UrunTuru = 'Küpe' ORDER BY MenuAdi ASC");
					...
					?>
						<tr height="30">
							<td><a href="index.php?sk=116&MenuID=<?php echo $Menu["id"]; ?>" style="text-decoration: none;<?php if($GelenMenuId==$Menu['id']){ ?> color: #cc0099;
		...
		<td width="1000" align="left" valign="top"><table width="1000" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td><div class="Arama"><form action="index.php?sk=116" method="post">
					<?php
					if($GelenMenuId!=""){
					?>
			...
			<tr>
				...
				<td width="203" style="border: 0.5px solid #ff00aa; text-align: center; padding: 10px 0;">
					<a href="index.php?sk=115" style="text-decoration: none; color: #ff00aa;">Fiyata Göre Artan</a></td>
				<td width="10">&nbsp;</td>
				<td width="203" style="border: 0.5px solid #ff00aa; text-align: center; padding: 10px 0;">
					<a href="index.php?sk=116" style="text-decoration: none; color: #ff00aa;">Fiyata Göre Azalan</a></td>
				<td width="10">&nbsp;</td>
				<td width="203" style="border: 0.5px solid #ff00aa; text-align: center; padding: 10px 0;">
					<a href="index.php?sk=117" style="text-decoration: none; color: #ff00aa;">Ada Göre A > Z</a></td>
				<td width="10">&nbsp;</td>
				<td width="203" style="border: 0.5px solid #ff00aa; text-align: center; padding: 10px 0;">
					<a href="index.php?sk=118" style="text-decoration: none; color: #ff00aa;">Ada Göre Z > A</a></td>
          <td width="10">&nbsp;</td>
          <td width="203" style="border: 0.5px solid #ff00aa; text-align: center; padding: 10px 0;">
          <a href="index.php?sk=81" style="text-decoration: none; color: #ff00aa;">Normal</a></td>
			</tr>
				</table></td>
			</tr>
			...
			<tr>
				<td><table width="795" align="center" border="0" cellpadding="0" cellspacing="0">
					<tr><?php
						$UrunlerSorgusu		=	$db_baglantisi->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Küpe' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY UrunFiyati DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaGosterilecekKayitSayisi");
						...
						?>
							<td width="191" valign="top">
								<table width="191" align="left" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 10px;">
									<tr height="40">
										<td align="center"><a href="index.php?sk=79&ID=<?php echo geriDondur($Kayit["id"]); ?>"><img src="urunler/kupeler/<?php echo geriDondur($Kayit["UrunResmi"]); ?>" border="0" width="185" height="247"></a></td>
									</tr>
									<tr height="25">
										<td width="191" align="center"><a href="index.php?sk=79&ID=<?php echo geriDondur($Kayit["id"]); ?>" style="color: #cc0099; font-weight: bold; text-decoration: none;">Küpe</a></td>
									</tr>
									<tr height="25">
			...
			<tr height="50">
				<td align="center"><div class="Sayfalama">
					...
					<div class="SayfalamaNumara">
						<?php
						if($Sayfalama>1){
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=116" . $SayfalamaKosulu . "&page=1'><<</a></span>";
							$SayfalamaIcinSayfaDegeriniBirGeriAl	=	$Sayfalama-1;
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=116" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirGeriAl . "'><</a></span>";
						}
						...
						for($SayfalamaIcinSayfaIndexDegeri=$Sayfalama-$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri<=$Sayfalama+$SayfalamaIcinSolVeSagButonSayisi; $SayfalamaIcinSayfaIndexDegeri++){
							if(($SayfalamaIcinSayfaIndexDegeri>0) and ($SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi)){
								if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
									...
									echo "<span class='SayfalamaPasif'><a href='index.php?sk=116" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaIndexDegeri . "'> " . $SayfalamaIcinSayfaIndexDegeri . "</a></span>";
								}
							}
						}
						if($Sayfalama!=$BulunanSayfaSayisi){
							$SayfalamaIcinSayfaDegeriniBirIleriAl	=	$Sayfalama+1;
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=116" . $SayfalamaKosulu . "&page=" . $SayfalamaIcinSayfaDegeriniBirIleriAl . "'>></a></span>";
							echo "<span class='SayfalamaPasif'><a href='index.php?sk=116" . $SayfalamaKosulu . "&page=" . $BulunanSayfaSayisi . "'>>></a></span>";
						}
						?>
					</div>
				</div></td>
